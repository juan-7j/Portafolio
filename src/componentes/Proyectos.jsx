...
const Proyectos = () => {
    return (
        <div className='border-b border-neutral-900 pb-a'>
            <motion.h2 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, x: -100 }} transition={{ duration: 0.5 }} className='my-20 text-center text-4xl'>Proyectos</motion.h2>
            <div>
                ...
                (
                    <div key={index} className='mb-8 flex flex-wrap lg:justify-center'>
                        ...
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1 }} className='w-full max-w-xl lg:w-3/4'>
                            ...
                            <p className='mb-4 text-neutral-400'>{project.descripcion}</p>
